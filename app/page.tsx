...
const services = [
  ...
  },
  {
    ...
    copy: "Integrated construction coordination, maintenance oversight, vendor management, and field-level problem solving for industrial assets.",
    image: "/images/assetstrat.png",
  },
];
...
const properties = [
  ...
  },
  {
    ...
    size: "64,000 SF",
    label: "Strategic market presence",
    image: "/images/property1.png",
  },
];
...
function HeroSection() {
  return (
    <div className="relative flex min-h-[92vh] w-full items-end overflow-hidden bg-zinc-900 px-6 pb-10 pt-28 md:px-10">
      <video
        autoPlay
        muted
        loop
...
export default function LangConcepts() {
  ...
  return (
    <main className="min-h-screen bg-[#eeeeec] text-zinc-900">
      ...
      <section id="firm" className="mx-auto grid w-full gap-4 px-6 py-16 md:grid-cols-2 lg:grid-cols-4 md:px-10 bg-[#f5f5f3] text-zinc-900 rounded-[2rem] mt-10">
        {services.map((service, index) => {
          const items = [
            ...
            ["Construction coordination", "Maintenance oversight", "Vendor management"],
          ][index];
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex flex-col justify-end p-7 text-center opacity-0 transition duration-500 group-hover:opacity-100">
                ...
                <div className="mt-2 flex flex-col gap-2">
                  {items.map((s) => (
                    <div key={s} className="text-sm font-semibold text-zinc-800">
                      {s}
                    </div>
                  ))}
                </div>
      ...
      <section id="properties" className="mx-auto w-full rounded-[2.5rem] bg-white px-6 py-24 md:px-10 text-zinc-900">
      ...
      <section id="team" className="mx-auto w-full px-6 py-20 md:px-10 bg-[#f5f5f3] rounded-[2rem] mt-10">
        <div className="rounded-[2rem] border border-white/10 bg-white p-6 md:p-10">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
            {team.map((person) => (
      ...
      <footer id="contact" className="mx-auto w-full px-6 pb-10 md:px-10">
